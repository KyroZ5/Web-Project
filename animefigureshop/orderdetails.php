    ...
    <div id="main" class="order-summary">
        ...
        <div class="order-left">
            ...
            <?php if ($order['logisticsMethod'] === 'Delivery') { ?>
                ...
                <p><?php echo $order['address']; ?> <?php echo $order['apartmentSuite']; ?></p>
           ...
           <form action="update_order.php" method="POST">
                ...
                <button class="approve" type="submit" name="action" value="Approve">Approve Order</button>
                <button class="reject" type="submit" name="action" value="Reject">Reject Order</button>
            </form>
        </div>
